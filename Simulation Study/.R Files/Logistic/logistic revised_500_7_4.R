#set.seed(100)
library(writexl) #To fix this design matrix for reuse under (n,p,p0)=(500,7,4)
...
design1
write_xlsx(design1,path = "M://Revised First Work//Logistic Related//logit_design_500_7_4.xlsx") # change the path according to your own directory named as "logit_design_500_7_4.xlsx"
...
## Import "logit_design_500_7_4.xlsx" first in R.
## Then replace line 29-55 with following line 62-64

#x=as.matrix(logit_design_500_7_4)
#design1=as.data.frame(x)
#design1
