#set.seed(100)
library(writexl) #To fix this design matrix for reuse under (n,p,p0)=(300,5,2)
library(CVXR) # for convex optimization


n=300 ## SAMPLE SIZE

p=5 ## number of parameter components
p_0=2 #non zero components
...
design1
write_xlsx(design1,path = "M://Revised First Work//Logistic Related//logit_design_300_5_2.xlsx") # change the path according to your own directory named as "logit_design_300_5_2.xlsx"
