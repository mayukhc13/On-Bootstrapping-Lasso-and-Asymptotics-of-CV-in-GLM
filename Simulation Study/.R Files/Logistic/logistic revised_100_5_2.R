#set.seed(100)
library(writexl) #To fix this design matrix for reuse under (n,p,p0)=(100,5,2)
...
design1
write_xlsx(design1,path = "M://Revised First Work//Logistic Related//logit_design_100_5_2.xlsx") # change the path according to your own directory named as "logit_design_100_5_2.xlsx"
