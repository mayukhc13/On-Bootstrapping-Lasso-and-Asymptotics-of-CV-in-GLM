#set.seed(100)
library(writexl) #To fix this design matrix for reuse under (n,p,p0)=(300,7,4)
...
design1
write_xlsx(design1,path = "M://Revised First Work//Logistic Related//logit_design_300_7_4.xlsx") # change the path according to your own directory named as "logit_design_300_7_4.xlsx"


## This step is for reusing fixed design after x is generated once and initially for one choice of a_n. Then comment out lines from line no. 29 up to line no. 55. 
## Import "logit_design_300_7_4.xlsx" first in R.
## Then replace line 29-55 with following line 62-64

#x=as.matrix(logit_design_300_7_4)
#design1=as.data.frame(x)
#design1
...
for(m in 1:simulation)
{
  ...
  ##we will choose via a_n=n^(-c) for 0<c<1/2, precisely c=0.0015,1/6, 1/5, 1/4, 1/3,0.485 
  ## Change choices of a_n accordingly
